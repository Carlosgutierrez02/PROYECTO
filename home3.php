			...
			<nav class="navbar">
				<div class="container-fluid">
					<img class="logo" src="./image/logo sin letras.png" alt="logo_sin">
						<h1 class="name">A.H.Ocamp Inventory Software</h1>
					<form class="d-flex">
						<a href="login.php" class=""><button class="btn1" type="button"> LOGIN</button></a>
	...
	<div id="row12" class="row12">
		<footer class="bg-transparent text-center text-black">
			...
			<div class="container p-4 pb-0">
				...
				<section class="mb-4">
					<!-- Facebook -->
					<a class="btn btn-outline-warning btn-floating m-1" href="#!" role="button" target="_blank"><i
							class="fab fa-facebook-f">
							<img class="logos" src="./image/logo-facebook.png" alt="Facebook">
						</i></a>

					<!-- Instagram -->
					<a class="btn btn-outline-warning btn-floating m-1" href="https://www.instagram.com/carlos_7.11/" role="button" target="_blank"><i
							class="fab fa-instagram">
							<img class="logos" src="./image/logo-instagram.png" alt="Instagram">
						</i></a>

					<!-- whatsapp -->
					<a class="btn btn-outline-warning btn-floating m-1" href="https://wa.me/3148731078" role="button" target="_blank"><i
			...
			<div class="text-center p-3" style="background-color: #87000006">
				<p style="color:yellow">© 2023 Copyright: <a class="text-white" href="https://autonoma.edu.co/"
						target="_blank">autonoma.edu.co</a></p>
